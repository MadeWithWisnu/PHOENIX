...
//                 optionsBuilder.UseSqlServer("Data Source=LAPTOP-TPSJNN09;Initial Catalog=Phoenix;Trusted_Connection=True;User=TrollMarket;Password=trollmarket;TrustServerCertificate=True");
//             }
//         }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Reservation>(entity =>
            {
                ...
                entity.HasOne(d => d.GuestUsernameNavigation)
                    ...
                    .HasConstraintName("FK__GuestUsername_Reservations");

                entity.HasOne(d => d.RoomNumberNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.RoomNumber)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_RoomNumber_Reservations");
            });
            ...
            modelBuilder.Entity<RoomInventory>(entity =>
            {
                ...
                entity.HasOne(d => d.InventoryNameNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_InventoryName_RoomInventories");

                entity.HasOne(d => d.RoomNumberNavigation)
                    .WithMany(p => p.RoomInventories)
                    .HasForeignKey(d => d.RoomNumber)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_RoomNumber_RoomInventories");
            });
